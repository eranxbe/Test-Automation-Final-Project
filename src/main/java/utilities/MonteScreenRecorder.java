...
public class MonteScreenRecorder extends ScreenRecorder{
    ...
    protected File createMovieFile (Format fileFormat) throws IOException {
        ...
        System.out.println(platform.equalsIgnoreCase("mobile") ? "" : "Recording file is created");
    ...
    public static void startRecord(String methodName) throws Exception {
        ...
        screenRecorder = new MonteScreenRecorder(gc, captureSize, new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_AVI),
